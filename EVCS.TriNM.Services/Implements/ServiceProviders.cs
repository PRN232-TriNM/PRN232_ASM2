    ...
    public class ServiceProviders : IServiceProviders
    {
        ...
        public IGoogleAuthService GoogleAuthService
        {
            ...
            { 
                ...
                {
                    _googleAuthService = new GoogleAuthService(UnitOfWork, Configuration);
                }
        ...
        public IStationService StationService
        {
            get 
            { 
                return _stationService ??= new StationService(UnitOfWork); 
            }
        }
        ...
        public IChargerService ChargerService
        {
            get 
            { 
                return _chargerService ??= new ChargerService(UnitOfWork); 
            }
        }
        ...
        public ITransactionService TransactionService
        {
            get 
            { 
                return new TransactionService(UnitOfWork); 
            }
        }
    }
}