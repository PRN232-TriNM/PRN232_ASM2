...
namespace EVCS.BlazorWebApp.TriNM.Models
{
    public partial class StationTriNM
    {
        ...
        [JsonProperty("stationTriNmcode")]
        public string StationTriNMCode { get; set; } = string.Empty;

        [Required(ErrorMessage = "Station Name is required")]
        [MaxLength(100, ErrorMessage = "Station Name cannot exceed 100 characters")]
        [JsonProperty("stationTriNmname")]
        public string StationTriNMName { get; set; } = string.Empty;
